...
public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.CatViewHolder> implements Filterable {
    private Context catContext;
    private ArrayList<BreedClass> catList;
    private ArrayList<BreedClass> catListFull;
    ...
    public MenuAdapter(Context context, ArrayList<BreedClass> list) {
        catContext = context;
        catList = list;
    ...
    public void onBindViewHolder(@NonNull CatViewHolder holder, int position) {
        BreedClass currentCat = catList.get(position);
    ...
    private Filter exampleFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<BreedClass> filteredList = new ArrayList<>();
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                for (BreedClass cat : catListFull) {
